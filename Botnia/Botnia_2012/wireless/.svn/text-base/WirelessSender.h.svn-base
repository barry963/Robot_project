...
#include "../datatypes/ParameterOperations.h"
#include "externInit.h"
#include <QByteArray>
#include <math.h>
...
#define HDLC_STARTSTOP 0x7E
#define HDLC_CTRL 0x03
#define HDLC_FR0 0xA3 // 1010 0011
#define HDLC_FR1 0xA7 // 1010 0111
#define HDLC_FR2 0xAB // 1010 1011
#define HDLC_FR3 0xAF // 1010 1111
...
static const unsigned char CHARSYN=0x7E;
static const unsigned char CHARESC=0xf0;
static const unsigned char ESC_SYN=0xf1;
static const unsigned char ESC_ESC=0xf2;
...
static char lastUsedAddrByte;
static QString botniaMac("RoboCup");
...
public:
	...
	void setRobotActions (int index, int kick, int dribble, int chipkick);
...
private:
	...
	void buildDECTPacket(int index);
	void addByte(QByteArray& tmpBuffer, char ch);
	void stopRobot(int robot, int offsetByte);
	void loadValues();

	unsigned int pppfcs16(char* data,int len);
	char nextaddr(char addr);
	
	// Data packet
	//char dataPacket[TOTAL_PACKET_SIZE];
	...
	// Robot Commands
	RobotCommand commands[NUM_AGENTS];
};
