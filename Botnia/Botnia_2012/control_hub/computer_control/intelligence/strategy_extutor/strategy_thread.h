...
struct RunStatus
{
    RUNSTATUSTYPE Status;		//×I²å????×I?×F? running status
    STRATEGYTYPE StrategyIndex;	//?ÛOÚ×I™t??×F  strategy type
    double dFreq;					//?ÛOÚ×I×I²å??×P¸LÚ×Q frequency
    char * tactic_name_;
};
extern QString sTactics[5];
extern RunStatus StatusOnGUI;	//?ÛOÚ×I??²é?
...
signals:
    void explains(); //?²õ³À?“\­®?×IÅS?“\ª]?µÈéğ×F??éğ?, explains??éğ?×Q×Jšñ‹_?¤ò¸L×H
    void guiRefresh(void);//?×IÅS?“\ª]??éğ?.
