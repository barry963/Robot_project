#ifndef FIELD_ANALYSOR_CONFIGREADER_H
#define FIELD_ANALYSOR_CONFIGREADER_H
/*
...
private:
    ...
    // check the file reader has been created or not
...
public:
    ...
    DataMap *FindDataMapping(char *_fname, char *_dataname, int _type, uint _count)
    {
