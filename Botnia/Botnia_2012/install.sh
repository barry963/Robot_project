#!/bin/bash
echo "change the /etc/apt/sourses.list to following"
echo "
...
"
sudo apt-get update
sudo apt-get install build-essential subversion g++ libqt4-dev libeigen2-dev  cmake libjpeg-dev libpng12-dev
cd net/message_serilization
./install_part.sh
cd ..
cd ..
qmake --makefile
